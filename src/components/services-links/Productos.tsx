...
const Productos: React.FC = () => {
    const cortes = [
        { id: 1, src: "public/media/Productos/productos1.jpeg", alt: "Producto-1" },
        { id: 2, src: "public/media/Productos/productos2.jpeg", alt: "Producto-2" },
        { id: 3, src: "public/media/Productos/productos3.jpeg", alt: "Producto-3" },
        { id: 4, src: "public/media/Productos/productos4.jpeg", alt: "Producto-4" },
        { id: 5, src: "public/media/Productos/productos5.jpeg", alt: "Producto-5" },
        { id: 6, src: "public/media/Productos/productos6.jpeg", alt: "Producto-6" },
        { id: 7, src: "public/media/Productos/productos7.jpeg", alt: "Producto-7" },
